...
internal static partial class vector_unsigned_int64_class_std_allocator_unsigned_int64_Operator
{
	[return: NativeType("unsigned __int64 &")]
	public unsafe static void* Invoke(void* @this, [MangledName("_Pos")][NativeType("unsigned __int64")] long Pos)
	{
		return unchecked((byte*)((std_vector_ucmdxb*)@this)->Mypair.Myval2.Myfirst + (nint)Pos * 8);
	}
}
