...
internal static partial class exception_Constructor_d3h3g6
{
	...
	public unsafe static void* Invoke(void* @this, [MangledName("_Other")][NativeType("class std::exception const &")] void* Other)
	{
		unchecked
		{
			*(byte**)@this = (byte*)(&Variable_unhbb7.__pointer->field_0) + sizeof(nint);
			llvm_memset_p0_i64.Invoke(&((std_exception*)@this)->Data, 0, 16L, isVolatile: false);
			std_exception_copy.Invoke(parameter_1: &((std_exception*)@this)->Data, parameter_0: &((std_exception*)Other)->Data);
