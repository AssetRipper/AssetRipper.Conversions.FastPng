...
internal static partial class vector_unsigned_int_class_std_allocator_unsigned_int_Operator
{
	[return: NativeType("unsigned int &")]
	public unsafe static void* Invoke(void* @this, [MangledName("_Pos")][NativeType("unsigned __int64")] long Pos)
	{
		return unchecked((byte*)((std_vector_jsyy6a*)@this)->Mypair.Myval2.Myfirst + (nint)Pos * 4);
	}
}
