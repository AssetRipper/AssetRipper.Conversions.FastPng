								...
								if ((uint)num6 < (uint)h)
								{
									...
									while (true)
									{
										...
										if ((num13 & 0x100) != 0)
										{
											...
											num20 = num11 + (ushort)((short*)g_run_len3_to_4.__pointer)[(uint)num16];
											if (num11 == num20)
											{
												goto IL_0ba2;
											}
											...
											if (ptr != null)
											{
												...
												{
													llvm_memcpy_p0_p0_i64.Invoke((byte*)ptr2 + (uint)num11, (byte*)ptr + (uint)num11, (uint)(num20 - num11), isVolatile: false);
													num11 = num20;
												}
												else
												{
