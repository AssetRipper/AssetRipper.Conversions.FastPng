	...
	public unsafe static bool Invoke(void* pSrc, int src_len, int zlib_len, void* pDst, int w, int h)
	{
		...
		unchecked
		{
			...
			else
			{
				...
				{
					bool instruction_2 = fpng_pixel_zlib_raw_decompress.Invoke(h: startFrame.GetLocalsRef<LocalVariables>().Instruction_1, w: startFrame.GetLocalsRef<LocalVariables>().Instruction_2, pDst: startFrame.GetLocalsRef<LocalVariables>().Instruction_3, zlib_len: startFrame.GetLocalsRef<LocalVariables>().Instruction_4, src_len: startFrame.GetLocalsRef<LocalVariables>().Instruction_5, pSrc: startFrame.GetLocalsRef<LocalVariables>().Instruction_6, src_chans: 4, dst_chans: 3);
					if (ExceptionInfo.Current != null)
					{
						return false;
					}
					...
					else
					{
						...
						else
						{
							...
							while (true)
							{
								if ((uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_18 < (uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_1)
								{
									...
									while (true)
									{
										...
										if ((startFrame.GetLocalsRef<LocalVariables>().Instruction_29 & 0x100) != 0)
										{
											...
											int instruction_62 = startFrame.GetLocalsRef<LocalVariables>().Instruction_32;
											startFrame.GetLocalsRef<LocalVariables>().Instruction_36 = (instruction_62 >>> 2) * 3;
											...
											startFrame.GetLocalsRef<LocalVariables>().Instruction_37 = instruction_63 + instruction_64;
											if ((uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_37 > (uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_7)
											{
												goto IL_14e4;
											}
											if (startFrame.GetLocalsRef<LocalVariables>().Instruction_16 != null)
											{
												...
												{
													llvm_memcpy_p0_p0_i64.Invoke((byte*)startFrame.GetLocalsRef<LocalVariables>().Instruction_17 + (uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_23, (byte*)startFrame.GetLocalsRef<LocalVariables>().Instruction_16 + (uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_23, (uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_36, isVolatile: false);
													int instruction_65 = startFrame.GetLocalsRef<LocalVariables>().Instruction_37;
												...
												else
												{
													...
													while ((uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_23 < (uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_37);
												}
											}
											else
											{
										...
										else
										{
											...
											startFrame.GetLocalsRef<LocalVariables>().Instruction_40 = instruction_71 >>> 25;
											if (startFrame.GetLocalsRef<LocalVariables>().Instruction_40 != 0)
											{
												...
												startFrame.GetLocalsRef<LocalVariables>().Instruction_38 = (instruction_72 >>> 16) & 0x1FF;
												int instruction_73 = startFrame.GetLocalsRef<LocalVariables>().Instruction_40;
												startFrame.GetLocalsRef<LocalVariables>().Instruction_42 = instruction_73;
												...
												int instruction_74 = startFrame.GetLocalsRef<LocalVariables>().Instruction_42;
												...
												int instruction_76 = startFrame.GetLocalsRef<LocalVariables>().Instruction_42;
												...
												startFrame.GetLocalsRef<LocalVariables>().Instruction_39 = instruction_78;
												int instruction_79 = startFrame.GetLocalsRef<LocalVariables>().Instruction_39;
												startFrame.GetLocalsRef<LocalVariables>().Instruction_41 = (instruction_79 >>> 9) & 0xF;
											...
											else
											{
												...
												startFrame.GetLocalsRef<LocalVariables>().Instruction_38 = instruction_80;
												int instruction_81 = startFrame.GetLocalsRef<LocalVariables>().Instruction_38;
												startFrame.GetLocalsRef<LocalVariables>().Instruction_43 = (instruction_81 >>> 9) & 0xF;
												if (startFrame.GetLocalsRef<LocalVariables>().Instruction_43 == 0)
												{
													goto IL_1e8d;
												}
												int instruction_82 = startFrame.GetLocalsRef<LocalVariables>().Instruction_43;
												startFrame.GetLocalsRef<LocalVariables>().Instruction_44 = instruction_82;
												if ((uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_44 <= 32u && (uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_10 >= (uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_44)
												{
													_ = -1;
												}
												else
												...
												int instruction_83 = startFrame.GetLocalsRef<LocalVariables>().Instruction_44;
												...
												int instruction_85 = startFrame.GetLocalsRef<LocalVariables>().Instruction_44;
												...
												int instruction_87 = startFrame.GetLocalsRef<LocalVariables>().Instruction_38;
												startFrame.GetLocalsRef<LocalVariables>().Instruction_41 = instruction_87 >>> 25;
												if (startFrame.GetLocalsRef<LocalVariables>().Instruction_41 != 0)
												{
													int instruction_88 = startFrame.GetLocalsRef<LocalVariables>().Instruction_38;
													startFrame.GetLocalsRef<LocalVariables>().Instruction_39 = instruction_88 >>> 16;
												}
												else
												{
													if ((uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_10 >= 12u)
													...
													startFrame.GetLocalsRef<LocalVariables>().Instruction_39 = instruction_89;
													int instruction_90 = startFrame.GetLocalsRef<LocalVariables>().Instruction_39;
													startFrame.GetLocalsRef<LocalVariables>().Instruction_41 = (instruction_90 >>> 9) & 0xF;
													if (startFrame.GetLocalsRef<LocalVariables>().Instruction_41 == 0)
													{
														goto IL_2149;
													}
											...
											startFrame.GetLocalsRef<LocalVariables>().Instruction_46 = instruction_91 >>> 25;
											if (startFrame.GetLocalsRef<LocalVariables>().Instruction_46 != 0)
											{
												int instruction_92 = startFrame.GetLocalsRef<LocalVariables>().Instruction_39;
												startFrame.GetLocalsRef<LocalVariables>().Instruction_45 = instruction_92 >>> 16;
												int instruction_93 = startFrame.GetLocalsRef<LocalVariables>().Instruction_41;
												int instruction_94 = startFrame.GetLocalsRef<LocalVariables>().Instruction_46;
												startFrame.GetLocalsRef<LocalVariables>().Instruction_47 = instruction_93 + instruction_94;
												...
												int instruction_95 = startFrame.GetLocalsRef<LocalVariables>().Instruction_47;
												...
												int instruction_97 = startFrame.GetLocalsRef<LocalVariables>().Instruction_47;
												...
												if ((uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_10 < 32u)
												{
													...
													startFrame.GetLocalsRef<LocalVariables>().Instruction_9 = instruction_99 | num12;
											...
											{
												int instruction_102 = startFrame.GetLocalsRef<LocalVariables>().Instruction_41;
												startFrame.GetLocalsRef<LocalVariables>().Instruction_48 = instruction_102;
												if ((uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_48 <= 32u)
												{
													_ = -1;
												}
												else
												...
												int instruction_103 = startFrame.GetLocalsRef<LocalVariables>().Instruction_48;
												...
												int instruction_105 = startFrame.GetLocalsRef<LocalVariables>().Instruction_48;
												...
												if ((uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_10 < 32u)
												{
													...
													startFrame.GetLocalsRef<LocalVariables>().Instruction_9 = instruction_107 | num13;
												...
												startFrame.GetLocalsRef<LocalVariables>().Instruction_46 = (instruction_111 >>> 9) & 0xF;
												if (startFrame.GetLocalsRef<LocalVariables>().Instruction_46 == 0)
												{
													goto IL_27d4;
												}
												int instruction_112 = startFrame.GetLocalsRef<LocalVariables>().Instruction_46;
												startFrame.GetLocalsRef<LocalVariables>().Instruction_49 = instruction_112;
												if ((uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_49 <= 32u && (uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_10 >= (uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_49)
												{
													_ = -1;
												}
												else
												...
												int instruction_113 = startFrame.GetLocalsRef<LocalVariables>().Instruction_49;
												...
												int instruction_115 = startFrame.GetLocalsRef<LocalVariables>().Instruction_49;
											...
											if (((startFrame.GetLocalsRef<LocalVariables>().Instruction_38 | startFrame.GetLocalsRef<LocalVariables>().Instruction_39 | startFrame.GetLocalsRef<LocalVariables>().Instruction_45) & 0x100) != 0)
											{
												goto IL_2986;
											}
											if (startFrame.GetLocalsRef<LocalVariables>().Instruction_16 != null)
											{
												...
												((sbyte*)startFrame.GetLocalsRef<LocalVariables>().Instruction_17)[(uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_23] = (sbyte)(num14 + instruction_117);
												...
												int instruction_118 = startFrame.GetLocalsRef<LocalVariables>().Instruction_38;
												((sbyte*)startFrame.GetLocalsRef<LocalVariables>().Instruction_17)[(uint)(startFrame.GetLocalsRef<LocalVariables>().Instruction_23 + 1)] = (sbyte)(num15 + instruction_118);
												...
												int instruction_119 = startFrame.GetLocalsRef<LocalVariables>().Instruction_39;
												((sbyte*)startFrame.GetLocalsRef<LocalVariables>().Instruction_17)[(uint)(startFrame.GetLocalsRef<LocalVariables>().Instruction_23 + 2)] = (sbyte)(num16 + instruction_119);
											}
											else
											{
												int instruction_120 = startFrame.GetLocalsRef<LocalVariables>().Instruction_29;
												((sbyte*)startFrame.GetLocalsRef<LocalVariables>().Instruction_17)[(uint)startFrame.GetLocalsRef<LocalVariables>().Instruction_23] = (sbyte)instruction_120;
												int instruction_121 = startFrame.GetLocalsRef<LocalVariables>().Instruction_38;
												((sbyte*)startFrame.GetLocalsRef<LocalVariables>().Instruction_17)[(uint)(startFrame.GetLocalsRef<LocalVariables>().Instruction_23 + 1)] = (sbyte)instruction_121;
												int instruction_122 = startFrame.GetLocalsRef<LocalVariables>().Instruction_39;
												((sbyte*)startFrame.GetLocalsRef<LocalVariables>().Instruction_17)[(uint)(startFrame.GetLocalsRef<LocalVariables>().Instruction_23 + 2)] = (sbyte)instruction_122;
											}
											int instruction_123 = startFrame.GetLocalsRef<LocalVariables>().Instruction_23;
											startFrame.GetLocalsRef<LocalVariables>().Instruction_23 = instruction_123 + 3;
											int instruction_124 = startFrame.GetLocalsRef<LocalVariables>().Instruction_29;
											startFrame.GetLocalsRef<LocalVariables>().Instruction_24 = (sbyte)instruction_124;
											int instruction_125 = startFrame.GetLocalsRef<LocalVariables>().Instruction_38;
											startFrame.GetLocalsRef<LocalVariables>().Instruction_25 = (sbyte)instruction_125;
											int instruction_126 = startFrame.GetLocalsRef<LocalVariables>().Instruction_39;
											startFrame.GetLocalsRef<LocalVariables>().Instruction_26 = (sbyte)instruction_126;
											int instruction_127 = startFrame.GetLocalsRef<LocalVariables>().Instruction_45;
											startFrame.GetLocalsRef<LocalVariables>().Instruction_27 = (sbyte)instruction_127;
										}
								...
								startFrame.GetLocalsRef<LocalVariables>().Instruction_50 = instruction_128;
								int instruction_129 = startFrame.GetLocalsRef<LocalVariables>().Instruction_50;
								startFrame.GetLocalsRef<LocalVariables>().Instruction_51 = (instruction_129 >>> 9) & 0xF;
								if (startFrame.GetLocalsRef<LocalVariables>().Instruction_51 == 0)
								{
									startFrame.GetLocalsRef<LocalVariables>().Instruction_0 = false;
									break;
								}
								int instruction_130 = startFrame.GetLocalsRef<LocalVariables>().Instruction_50;
								startFrame.GetLocalsRef<LocalVariables>().Instruction_50 = instruction_130 & 0x1FF;
								if (startFrame.GetLocalsRef<LocalVariables>().Instruction_50 != 256)
								{
									startFrame.GetLocalsRef<LocalVariables>().Instruction_0 = false;
									break;
								}
								int instruction_131 = startFrame.GetLocalsRef<LocalVariables>().Instruction_51;
								int instruction_132 = startFrame.GetLocalsRef<LocalVariables>().Instruction_10;
								startFrame.GetLocalsRef<LocalVariables>().Instruction_10 = instruction_132 - instruction_131;
								int instruction_133 = startFrame.GetLocalsRef<LocalVariables>().Instruction_51;
								long instruction_134 = startFrame.GetLocalsRef<LocalVariables>().Instruction_9;
								startFrame.GetLocalsRef<LocalVariables>().Instruction_9 = instruction_134 >>> (int)(uint)instruction_133;
								int instruction_135 = startFrame.GetLocalsRef<LocalVariables>().Instruction_10;
								startFrame.GetLocalsRef<LocalVariables>().Instruction_52 = instruction_135 & 7;
								int instruction_136 = startFrame.GetLocalsRef<LocalVariables>().Instruction_52;
								int instruction_137 = startFrame.GetLocalsRef<LocalVariables>().Instruction_10;
								startFrame.GetLocalsRef<LocalVariables>().Instruction_10 = instruction_137 - instruction_136;
								int instruction_138 = startFrame.GetLocalsRef<LocalVariables>().Instruction_52;
								long instruction_139 = startFrame.GetLocalsRef<LocalVariables>().Instruction_9;
								startFrame.GetLocalsRef<LocalVariables>().Instruction_9 = instruction_139 >>> (int)(uint)instruction_138;
								...
								int num17 = startFrame.GetLocalsRef<LocalVariables>().Instruction_10 >>> 3;
								int instruction_140 = startFrame.GetLocalsRef<LocalVariables>().Instruction_8;
								startFrame.GetLocalsRef<LocalVariables>().Instruction_8 = instruction_140 - num17;
								...
								break;
								IL_2e3a:
								void* instruction_141 = startFrame.GetLocalsRef<LocalVariables>().Instruction_17;
								startFrame.GetLocalsRef<LocalVariables>().Instruction_16 = instruction_141;
								int instruction_142 = startFrame.GetLocalsRef<LocalVariables>().Instruction_7;
								void* instruction_143 = startFrame.GetLocalsRef<LocalVariables>().Instruction_17;
								startFrame.GetLocalsRef<LocalVariables>().Instruction_17 = (byte*)instruction_143 + (uint)instruction_142;
								int instruction_144 = startFrame.GetLocalsRef<LocalVariables>().Instruction_18;
								startFrame.GetLocalsRef<LocalVariables>().Instruction_18 = instruction_144 + 1;
								continue;
								IL_1036:
								startFrame.GetLocalsRef<LocalVariables>().Instruction_0 = false;
								break;
		...
		IL_3281:
		bool instruction_145 = startFrame.GetLocalsRef<LocalVariables>().Instruction_0;
		StackFrameList.Current.Clear(startFrame);
		return instruction_145;
	}
}
