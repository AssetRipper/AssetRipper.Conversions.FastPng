...
internal static partial class Resize_reallocate_ytnsorc
{
	...
	public unsafe static void Invoke(void* @this, [MangledName("_Newsize")][NativeType("unsigned __int64")] long Newsize, [MangledName("_Val")][NativeType("struct std::_Value_init_tag const &")] void* Val)
	{
		...
		unchecked
		{
			...
			localsPointer->field_0 = Calculate_growth_vbhwmec.Invoke(@this, Newsize);
			void* ptr2 = Allocate_at_least_helper_l9zi7qb.Invoke(ptr, &localsPointer->field_0);
			...
			void* ptr5 = Uninitialized_value_construct_n_hqowyoc.Invoke(ptr4, Newsize - num, ptr);
			if (ExceptionInfo.Current == null)
			{
				*(void**)field_ = ptr5;
				Uninitialized_move_cbc4pbc.Invoke(Al: ptr, Dest: ptr3, Last: *(void**)mylast, First: *(void**)myfirst);
				if (ExceptionInfo.Current == null)
				{
					localsPointer->field_1.field_1 = null;
					Change_array_hgqy2vc.Invoke(@this, ptr3, Newsize, localsPointer->field_0);
					Reallocation_guard_Destructor_jfaqped.Invoke(&localsPointer->field_1);
