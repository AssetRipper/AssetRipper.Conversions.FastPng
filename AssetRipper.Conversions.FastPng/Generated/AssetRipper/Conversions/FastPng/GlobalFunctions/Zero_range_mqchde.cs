...
internal static partial class Zero_range_mqchde
{
	...
	public unsafe static void* Invoke([MangledName("_First")][NativeType("unsigned int *const")] void* First, [MangledName("_Last")][NativeType("unsigned int *const")] void* Last)
	{
		void* result = Last;
		void* ptr = First;
		void* ptr2 = To_address_vfzm44.Invoke(&ptr);
		llvm_memset_p0_i64.Invoke(ptr2, 0, unchecked((long)To_address_vfzm44.Invoke(&result) - (long)ptr2), isVolatile: false);
		return result;
	}
}
