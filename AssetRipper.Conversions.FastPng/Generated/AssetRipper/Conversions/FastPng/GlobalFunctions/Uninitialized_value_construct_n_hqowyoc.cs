...
internal static partial class Uninitialized_value_construct_n_hqowyoc
{
	...
	{
		void* ptr = Unfancy_z2hkbxa.Invoke(First);
		unchecked
		{
			Zero_range_lx9svca.Invoke(ptr, (byte*)ptr + (nint)Count * 8);
