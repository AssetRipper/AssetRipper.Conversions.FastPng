...
internal static partial class fpng_pixel_zlib_decompress_3_b29a29
{
	...
	public unsafe static bool Invoke([NativeType("unsigned char const *")] void* pSrc, [NativeType("unsigned int")] int src_len, [NativeType("unsigned int")] int zlib_len, [NativeType("unsigned char *")] void* pDst, [NativeType("unsigned int")] int w, [NativeType("unsigned int")] int h)
	{
		...
		unchecked
		{
			...
			{
				wassert.Invoke(String_wv8pqk.__pointer, String_ksmiy6.__pointer, 2214);
			...
			else
			{
				...
				{
					bool flag2 = fpng_pixel_zlib_raw_decompress.Invoke(pSrc, src_len, zlib_len, pDst, w, h, 3, 4);
					if (ExceptionInfo.Current != null)
					{
						return false;
					}
				...
				else
				{
					...
					{
						wassert.Invoke(String_f74ax6.__pointer, String_ksmiy6.__pointer, 2239);
						if (ExceptionInfo.Current != null)
						{
							return false;
						}
					...
					{
						wassert.Invoke(String_f74ax6.__pointer, String_ksmiy6.__pointer, 2240);
						if (ExceptionInfo.Current != null)
						{
							return false;
						}
						...
						else
						{
							...
							while (true)
							{
								if ((uint)num6 < (uint)h)
								{
									...
									{
										wassert.Invoke(String_vetfdg.__pointer, String_ksmiy6.__pointer, 2256);
										if (ExceptionInfo.Current != null)
										{
											return false;
										}
									...
									if ((uint)num10 > 32u)
									{
										wassert.Invoke(String_j9965d.__pointer, String_ksmiy6.__pointer, 2261);
										if (ExceptionInfo.Current != null)
										{
											return false;
										}
									...
									while (true)
									{
										if ((uint)localsPointer->field_2 < 12u)
										{
											wassert.Invoke(String_vetfdg.__pointer, String_ksmiy6.__pointer, 2272);
											if (ExceptionInfo.Current != null)
											{
												return false;
											}
										...
										if ((uint)num16 > 32u)
										{
											wassert.Invoke(String_j9965d.__pointer, String_ksmiy6.__pointer, 2279);
											if (ExceptionInfo.Current != null)
											{
												return false;
											}
										...
										if ((num14 & 0x100) != 0)
										{
											...
											if ((uint)num14 >= 265u)
											{
												...
												{
													wassert.Invoke(String_t338gg.__pointer, String_ksmiy6.__pointer, 2294);
													if (ExceptionInfo.Current != null)
													{
														return false;
													}
											...
											{
												wassert.Invoke(String_s5c4mv.__pointer, String_ksmiy6.__pointer, 2300);
												if (ExceptionInfo.Current != null)
												{
													return false;
												}
											...
											if ((uint)num17 % 3u != 0)
											{
												wassert.Invoke(String_gn3izp.__pointer, String_ksmiy6.__pointer, 2303);
												if (ExceptionInfo.Current != null)
												{
													return false;
												}
											}
											int num21 = num11 + (ushort)((short*)g_run_len3_to_4.__pointer)[(uint)num17];
											if (num11 == num21)
											{
												goto IL_097f;
											}
											...
											if (ptr != null)
											{
												...
												{
													llvm_memcpy_p0_p0_i64.Invoke((byte*)ptr2 + (uint)num11, (byte*)ptr + (uint)num11, (uint)(num21 - num11), isVolatile: false);
													num11 = num21;
												}
												else
												{
										...
										else
										{
											...
											if (num22 != 0)
											{
												...
												{
													wassert.Invoke(String_s5c4mv.__pointer, String_ksmiy6.__pointer, 2399);
													if (ExceptionInfo.Current != null)
													{
														return false;
													}
												...
												if ((uint)localsPointer->field_2 < 12u)
												{
													wassert.Invoke(String_vetfdg.__pointer, String_ksmiy6.__pointer, 2401);
													if (ExceptionInfo.Current != null)
													{
														return false;
													}
											...
											else
											{
												if ((uint)localsPointer->field_2 < 12u)
												{
													wassert.Invoke(String_vetfdg.__pointer, String_ksmiy6.__pointer, 2409);
													if (ExceptionInfo.Current != null)
													{
														return false;
													}
												...
												{
													wassert.Invoke(String_s5c4mv.__pointer, String_ksmiy6.__pointer, 2414);
													if (ExceptionInfo.Current != null)
													{
														return false;
													}
												...
												else
												{
													if ((uint)localsPointer->field_2 < 12u)
													{
														wassert.Invoke(String_vetfdg.__pointer, String_ksmiy6.__pointer, 2421);
														if (ExceptionInfo.Current != null)
														{
															return false;
														}
											...
											if ((uint)num32 > 32u)
											{
												wassert.Invoke(String_j9965d.__pointer, String_ksmiy6.__pointer, 2429);
												if (ExceptionInfo.Current != null)
												{
													return false;
												}
											...
											if (num33 != 0 && (uint)num11 < (uint)num)
											{
												...
												if ((uint)num14 < 256u)
												{
													...
													{
														wassert.Invoke(String_s5c4mv.__pointer, String_ksmiy6.__pointer, 2481);
														if (ExceptionInfo.Current != null)
														{
															return false;
														}
													...
													if ((uint)localsPointer->field_2 < 12u)
													{
														wassert.Invoke(String_vetfdg.__pointer, String_ksmiy6.__pointer, 2483);
														if (ExceptionInfo.Current != null)
														{
															return false;
														}
													...
													if ((uint)num37 > 32u)
													{
														wassert.Invoke(String_j9965d.__pointer, String_ksmiy6.__pointer, 2488);
														if (ExceptionInfo.Current != null)
														{
															return false;
														}
													...
													else
													{
														if ((uint)localsPointer->field_2 < 12u)
														{
															wassert.Invoke(String_vetfdg.__pointer, String_ksmiy6.__pointer, 2495);
															if (ExceptionInfo.Current != null)
															{
																return false;
															}
													...
													{
														wassert.Invoke(String_s5c4mv.__pointer, String_ksmiy6.__pointer, 2502);
														if (ExceptionInfo.Current != null)
														{
															return false;
														}
								...
								if ((uint)localsPointer->field_2 < 12u)
								{
									wassert.Invoke(String_vetfdg.__pointer, String_ksmiy6.__pointer, 2560);
									if (ExceptionInfo.Current != null)
									{
										return false;
									}
