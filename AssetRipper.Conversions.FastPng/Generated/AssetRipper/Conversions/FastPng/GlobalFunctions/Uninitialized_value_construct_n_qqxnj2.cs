...
internal static partial class Uninitialized_value_construct_n_qqxnj2
{
	...
	{
		void* ptr = Unfancy_up4piv.Invoke(First);
		unchecked
		{
			Zero_range_mqchde.Invoke(ptr, (byte*)ptr + (nint)Count * 4);
