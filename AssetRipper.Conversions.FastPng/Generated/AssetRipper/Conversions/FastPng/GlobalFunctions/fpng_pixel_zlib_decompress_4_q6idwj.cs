...
internal static partial class fpng_pixel_zlib_decompress_4_q6idwj
{
					...
					else
					{
						...
						else
						{
							...
							while (true)
							{
									...
									while (true)
									{
										...
										else
										{
											...
											else
											{
												...
												long num36 = localsPointer->field_1 & 0xFFFL;
												num33 = ((int*)(&localsPointer->field_3))[num36];
												num32 = (num33 >>> 9) & 0xF;
												if (num32 == 0)
												{
													goto IL_0fa4;
												...
												int num37 = num32;
												if ((uint)num37 > 32u || (uint)localsPointer->field_2 < (uint)num37)
												{
											...
											if (ptr != null)
											{
												...
												((sbyte*)ptr2)[(uint)(num11 + 3)] = (sbyte)((byte)((sbyte*)ptr)[(uint)(num11 + 3)] + num33);
											}
											else
											{
												...
												((sbyte*)ptr2)[(uint)(num11 + 3)] = (sbyte)num33;
											}
											num11 += 4;
											b = (sbyte)num14;
											b2 = (sbyte)num23;
								...
								int num39 = ((int*)(&localsPointer->field_3))[num38];
								int num40 = (num39 >>> 9) & 0xF;
								if (num40 == 0)
								{
									flag = false;
									break;
								...
								localsPointer->field_2 -= num40;
								localsPointer->field_1 >>>= (int)(uint)num40;
								int num41 = localsPointer->field_2 & 7;
